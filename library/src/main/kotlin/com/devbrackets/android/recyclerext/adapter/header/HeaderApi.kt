...
interface HeaderApi<H : RecyclerView.ViewHolder?, C : RecyclerView.ViewHolder?> : HeaderDataGenerator.DataSource {
     ...
     *
     * @return The [HeaderDataGenerator.HeaderData]
     */
    /**
     ...
     *
     * @param headerData The [HeaderDataGenerator.HeaderData]
     */
     ...
     *
     * @return `true` if the headers are automatically updated
     */
    /**
     * Sets if the headers should automatically be calculated on any
     * adapter change (notified by the [HeaderAdapterDataObserver]).
     *
     * @param autoUpdateHeaders `true` if the headers should auto update
     */
