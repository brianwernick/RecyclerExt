...
public abstract class BaseLayoutManager extends InternalBaseLayoutManager {
    ...
    protected final Lanes.LaneInfo tempLaneInfo = new Lanes.LaneInfo();
    ...
    public void getLaneForChild(Lanes.LaneInfo outInfo, View child, LayoutDirection direction) {
    ...
    public abstract void getLaneForPosition(Lanes.LaneInfo outInfo, int position, LayoutDirection direction);
